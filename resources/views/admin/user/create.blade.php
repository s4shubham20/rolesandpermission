                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="Enter email here !" value="{{ old('email') }}"/>
                                                    @error('email')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="multiple-select-custom" name="role" id="role" class="form-select" data-placeholder="Choose user role">
                                                        @foreach ($role as $item)
                                                            <option value="{{ $item->id }}" {{ old('role') ? "selected":"" }}>{{ Str::title($item->name) }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('role')
                                                        <span class="text-danger">{{ $message }}</span>
